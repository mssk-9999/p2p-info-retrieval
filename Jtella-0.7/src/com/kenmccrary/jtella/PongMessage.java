...
public class PongMessage extends Message
{
   ...
   *
   */
  private void init(short port, String ipAddress, int fileCount, int fileSize)
  {
    this.port = port;
 ...
 */
  ...
  String getIPAddress()
  {
    ...
    ipBuffer.append(Integer.toString(payload[2])).
             append(".").
