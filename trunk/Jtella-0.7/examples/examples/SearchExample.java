...
public class SearchExample
{
  ...
  public static void main(String[] args)
  {
    ...
    try
    {
      ...
      SearchSession search1 = c.createSearchSession("kanye west", 
                                                     100, 
                                                     0, 
                                                     new TestReceiver());

      SearchSession search2 = c.createSearchSession("taylor swift", 
                                                     100, 
                                                     0, 
                                                     new TestReceiver());
      ...
      SearchSession search4 = c.createSearchSession("fall out boy",
    		  										 100, 
    		  										 0, 
    		  										 new TestReceiver());
